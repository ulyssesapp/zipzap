...
/*!
 ...
 @discussion See ISO 29500-1:2012: §17.15 (Settings). The settings will be stored inside the settings.xml file inside the output document. Should be called before the relationships translation.
 */
