...
- (void)testGenerateFootnote
{
    ...
    STAssertEqualObjects([taggedString flattenedRTFString],
                         @">{\\super \\chftn }{\\footnote {\\super \\chftn } \\pard\\ql\\pardeftab0 \\cb1 \\cf0 \\f0 \\fs32\\fsmilli16000 \\strikec0 \\strokec0 \\ulc0 aaa\\par\n}<",
...
- (void)testGenerateEndnote
{
    ...
    // Valid string tagging
    STAssertEqualObjects([taggedString flattenedRTFString],
                         @">{\\super \\chftn }{\\footnote\\ftnalt {\\super \\chftn } \\pard\\ql\\pardeftab0 \\cb1 \\cf0 \\f0 \\fs32\\fsmilli16000 \\strikec0 \\strokec0 \\ulc0 aaa\\par\n}<",
                         @"Invalid footnote generated"
                         );
