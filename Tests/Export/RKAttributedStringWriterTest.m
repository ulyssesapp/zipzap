//
//  RKAttributedStringWriterTest.m
//  RTFKit
//
...
#import "RKAttributedStringWriter+TextExtensions.h"
...
- (void)testTranslateDefaultParagraphStyle
{
    ...
    STAssertEqualObjects([RKAttributedStringWriter RTFfromParagraphStyle:paragraphStyle],
                         @"\\pard"
